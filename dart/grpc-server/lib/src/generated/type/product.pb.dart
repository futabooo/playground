...
class Product extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Product', package: const $pb.PackageName(_omitMessageNames ? '' : 'type'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'id')
    ..aOS(2, _omitFieldNames ? '' : 'name')
    ..a<$core.double>(4, _omitFieldNames ? '' : 'price', $pb.PbFieldType.OF)
    ..aOM<$2.Category>(5, _omitFieldNames ? '' : 'category', subBuilder: $2.Category.create)
  ...
  @$pb.TagNumber(5)
  $2.Category get category => $_getN(3);
  @$pb.TagNumber(5)
  set category($2.Category v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasCategory() => $_has(3);
  @$pb.TagNumber(5)
  void clearCategory() => clearField(5);
  @$pb.TagNumber(5)
  $2.Category ensureCategory() => $_ensure(3);
}
